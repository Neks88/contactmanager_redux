...
"# contactmanager_redux"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/Neks88/contactmanager_redux.git git push -u origin master
